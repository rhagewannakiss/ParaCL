...
inline void VarDeclNode::accept(Visitor& v)
{
    v.visit(*this);
}
inline void ForNode::accept(Visitor& v)
{
    v.visit(*this);
}
inline void ErrorNode::accept(Visitor& v)
{
    v.visit(*this);
}
inline void EmptyNode::accept(Visitor& v)
{
    v.visit(*this);
}
