...
TEST(BaseSmokeTest, IfNodeTest)
{
    ...
    auto c1 = std::make_unique<ast::BinLogicOpNode>(
        ast::bin_logic_op_type::greater, std::move(v11), std::move(v21));
    ...
    auto th1 = std::make_unique<ast::BinArithOpNode>(
        ast::bin_arith_op_type::add, std::move(v31), std::move(v41));
    ...
    auto c2 = std::make_unique<ast::BinLogicOpNode>(
        ast::bin_logic_op_type::greater, std::move(v12), std::move(v22));
    ...
    auto th2 = std::make_unique<ast::BinArithOpNode>(
        ast::bin_arith_op_type::add, std::move(v32), std::move(v42));
    ...
    auto e2 = std::make_unique<ast::BinArithOpNode>(
        ast::bin_arith_op_type::sub, std::move(v52), std::move(v62));
...
TEST(BaseSmokeTest, WhileNodeTest)
{
    ...
    auto c = std::make_unique<ast::BinLogicOpNode>(
        ast::bin_logic_op_type::greater, std::move(v1), std::move(v2));
    ...
    auto b = std::make_unique<ast::BinArithOpNode>(
        ast::bin_arith_op_type::add, std::move(v3), std::move(v4));
...
TEST(BaseSmokeTest, BinArithOpNode)
{
    ...
    ast::BinArithOpNode b(
        ast::bin_arith_op_type::add, std::move(v1), std::move(v2));
...
TEST(BaseSmokeTest, ScopeNodeTest)
{
    ...
    auto a1 =
        std::make_unique<ast::AssignNode>(std::move(var1), std::move(val1));

    auto var2 = std::make_unique<ast::VarNode>("b");
    auto val2 = std::make_unique<ast::ValueNode>(6969);
    auto a2 =
        std::make_unique<ast::AssignNode>(std::move(var2), std::move(val2));
...
{
    auto i =
        std::make_unique<ast::AssignNode>(std::make_unique<ast::VarNode>("var"),
    ...
    auto b =
        std::make_unique<ast::PrintNode>(std::make_unique<ast::VarNode>("var"));
...
TEST(BaseSmokeTest, BaseNodeSafetyTest)
{
    ...
    EXPECT_THROW(s.add_statement(nullptr), std::runtime_error);
    ...
    TempNode tn;
    EXPECT_THROW(tn.ask_add_child_front(nullptr), std::runtime_error);
}
